		...
		<div class="container">
			...
			<div class="contact-content">
				...
				<div class="row">
					<div class="col-md-4 gap-right-md gap-bottom-normal">
						<div class="form-elem input-box">
							<input type="text" placeholder="societe" value="">
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-4 gap-right-md gap-bottom-normal">
						<div class="form-elem input-box">
							<input type="text" placeholder="practice métier" value="">
						</div>
					</div>

					<div class="col-md-4 gap-left-md gap-right-md gap-bottom-normal">
						<div class="form-elem input-box">
							<input type="text" placeholder="intitulé de poste" value="">
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-4 gap-left-md gap-right-md gap-bottom-normal">
						<div class="form-elem input-box">
							<input type="text" placeholder="budget prévu" value="">
						</div>
					</div>
					
					<div class="col-md-4 gap-left-md gap-bottom-normal">
						<div class="form-elem input-date">
							<input type='text' class="form-datetime" placeholder="date souhaitée d’intégration"/>
						</div>
					</div>
				...
				<div class="row gap-bottom-lg">
					<div class="col-md-4 gap-bottom-normal">
						<fieldset class="switch-buttons switch-button-extra gap-bottom-normal">
							...
							<input type="radio" name="cdd" id="cdd">
							<label for="cdi">CDI</label>
							<input type="radio" name="cdd" id="cdi">
						</fieldset>
					</div>
				</div><!-- ./row -->
				...
				<!-- Number 4 -->
				<p class="number-list gap-bottom-normal">
					<span class="number">4</span>Téléchargez votre descriptif pré établi ?
				</p>

				<div class="text-center gap-bottom-normal">
					<span class="inputfile-descrption">Joindre le fichier word / pdf :</span>
